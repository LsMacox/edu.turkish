...
// ============================================================================
// INFO ITEM STYLES (for DetailKeyInfoSection)
// ============================================================================
...
const INFO_ITEM_STYLES: Record<string, InfoItemStyle> = {
  ...
  foundedYear: { icon: 'ph:calendar', iconBg: 'bg-purple-100', iconColor: 'text-purple-600' },
  cost: { icon: 'ph:currency-dollar', iconBg: 'bg-green-100', iconColor: 'text-green-600' },
  languages: { icon: 'ph:translate', iconBg: 'bg-orange-100', iconColor: 'text-orange-600' },
  students: { icon: 'ph:users', iconBg: 'bg-pink-100', iconColor: 'text-pink-600' },
  accommodation: { icon: 'ph:bed', iconBg: 'bg-indigo-100', iconColor: 'text-indigo-600' },
  ranking: { icon: 'ph:trophy', iconBg: 'bg-yellow-100', iconColor: 'text-yellow-600' },
  internationalStudents: { icon: 'ph:globe', iconBg: 'bg-teal-100', iconColor: 'text-teal-600' },
}
