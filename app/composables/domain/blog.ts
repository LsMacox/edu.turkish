...
export const CONTENT_VARIANT_STYLES: Record<ContentVariant, VariantStyles> = {
    article: {
        container: 'space-y-5',
...
export function getContentVariantStyles(variant: ContentVariant): VariantStyles {
    return CONTENT_VARIANT_STYLES[variant]
}
