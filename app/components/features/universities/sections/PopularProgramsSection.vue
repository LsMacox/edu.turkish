      ...
      <div v-else class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        >
          ...
          <p class="text-gray-600 mb-4">
            {{ $t('universities_page.popular_programs.programs.it.description') }}
          </p>
          <div class="flex items-center justify-between text-sm mt-auto pt-2">
            <span class="text-gray-500">{{
              dynamicData?.it
                ? formatUniversitiesCount(dynamicData.it.universities_count)
                : $t('universities_page.popular_programs.programs.it.universities_count')
            }}</span>
            <span class="text-primary font-medium">{{
              dynamicData?.it
                ? formatPrice(dynamicData.it.price_from)
                : $t('universities_page.popular_programs.programs.it.price_from')
            }}</span>
          </div>
        </div>
        ...
        >
          ...
          <p class="text-gray-600 mb-4">
            {{ $t('universities_page.popular_programs.programs.medicine.description') }}
          </p>
          <div class="flex items-center justify-between text-sm mt-auto pt-2">
            <span class="text-gray-500">{{
              dynamicData?.medicine
                ? formatUniversitiesCount(dynamicData.medicine.universities_count)
                : $t('universities_page.popular_programs.programs.medicine.universities_count')
            }}</span>
            <span class="text-primary font-medium">{{
              dynamicData?.medicine
                ? formatPrice(dynamicData.medicine.price_from)
                : $t('universities_page.popular_programs.programs.medicine.price_from')
            }}</span>
          </div>
        </div>
        ...
        >
          ...
          <p class="text-gray-600 mb-4">
            {{ $t('universities_page.popular_programs.programs.engineering.description') }}
          </p>
          <div class="flex items-center justify-between text-sm mt-auto pt-2">
            <span class="text-gray-500">{{
              dynamicData?.engineering
                ? formatUniversitiesCount(dynamicData.engineering.universities_count)
                : $t('universities_page.popular_programs.programs.engineering.universities_count')
            }}</span>
            <span class="text-primary font-medium">{{
              dynamicData?.engineering
                ? formatPrice(dynamicData.engineering.price_from)
                : $t('universities_page.popular_programs.programs.engineering.price_from')
            }}</span>
          </div>
        </div>
        ...
        >
          ...
          <p class="text-gray-600 mb-4">
            {{ $t('universities_page.popular_programs.programs.business.description') }}
          </p>
          <div class="flex items-center justify-between text-sm mt-auto pt-2">
            <span class="text-gray-500">{{
              dynamicData?.business
                ? formatUniversitiesCount(dynamicData.business.universities_count)
                : $t('universities_page.popular_programs.programs.business.universities_count')
            }}</span>
            <span class="text-primary font-medium">{{
              dynamicData?.business
                ? formatPrice(dynamicData.business.price_from)
                : $t('universities_page.popular_programs.programs.business.price_from')
            }}</span>
          </div>
        </div>
        ...
        >
          ...
          <p class="text-gray-600 mb-4">
            {{ $t('universities_page.popular_programs.programs.design.description') }}
          </p>
          <div class="flex items-center justify-between text-sm mt-auto pt-2">
            <span class="text-gray-500">{{
              dynamicData?.design
                ? formatUniversitiesCount(dynamicData.design.universities_count)
                : $t('universities_page.popular_programs.programs.design.universities_count')
            }}</span>
            <span class="text-primary font-medium">{{
              dynamicData?.design
                ? formatPrice(dynamicData.design.price_from)
                : $t('universities_page.popular_programs.programs.design.price_from')
            }}</span>
          </div>
        </div>
        ...
        >
          ...
          <p class="text-gray-600 mb-4">
            {{ $t('universities_page.popular_programs.programs.international.description') }}
          </p>
          <div class="flex items-center justify-between text-sm mt-auto pt-2">
            <span class="text-gray-500">{{
              dynamicData?.international
                ? formatUniversitiesCount(dynamicData.international.universities_count)
                : $t('universities_page.popular_programs.programs.international.universities_count')
            }}</span>
            <span class="text-primary font-medium">{{
              dynamicData?.international
                ? formatPrice(dynamicData.international.price_from)
                : $t('universities_page.popular_programs.programs.international.price_from')
            }}</span>
          </div>
        </div>
      </div>
