<template>
  <section id="how-to-choose" class="section-py bg-gradient-to-b from-white to-gray-50">
    <div class="container">
      ...
      <div class="relative">
        <div class="hidden lg:block absolute top-12 left-[12.5%] right-[12.5%] h-0.5 bg-gradient-to-r from-blue-200 via-purple-200 to-orange-200" />
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
          ...
          >
            ...
            <!-- Card -->
            <div 
              class="relative bg-white rounded-2xl border border-gray-100 p-6 text-center h-full
                     transition-all duration-300 ease-out
                     hover:shadow-xl hover:-translate-y-1 hover:border-gray-200
                     group-hover:bg-gradient-to-b group-hover:from-white group-hover:to-gray-50/50"
            >
              <!-- Mobile step number -->
              ...
              <div class="relative mx-auto mb-5 w-16 h-16">
                ...
                <div
                  ...
                  :class="tip.bgColor"
                >
                  <Icon :name="tip.icon" class="text-2xl transition-transform duration-300 group-hover:scale-110" :class="tip.iconColor" />
                </div>
              </div>

              <h3 class="text-lg font-semibold text-secondary mb-3 group-hover:text-primary transition-colors">
