    ...
    <section class="py-16 bg-white">
      <div class="container mx-auto px-4 lg:px-6">
        <div class="text-center mb-12">
          <h2 class="text-3xl lg:text-4xl font-bold text-secondary mb-4">{{ $t('universityDetail.keyInformation.title') }}</h2>
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div class="bg-white rounded-2xl shadow-custom p-6 text-center hover-lift">
            ...
            <h3 class="text-lg font-semibold text-secondary mb-2">{{ $t('universityDetail.keyInformation.city') }}</h3>
          ...
          <div class="bg-white rounded-2xl shadow-custom p-6 text-center hover-lift">
            ...
            <h3 class="text-lg font-semibold text-secondary mb-2">{{ $t('universityDetail.keyInformation.foundedYear') }}</h3>
          ...
          <div class="bg-white rounded-2xl shadow-custom p-6 text-center hover-lift">
            ...
            <h3 class="text-lg font-semibold text-secondary mb-2">{{ $t('universityDetail.keyInformation.cost') }}</h3>
            <p class="text-gray-600">
              {{ $t('universityDetail.keyInformation.costFrom', { 
                cost: '$' + (university.keyInfo.priceFrom || 0).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ' ')
              }) }}
            </p>
          </div>
          ...
          <div class="bg-white rounded-2xl shadow-custom p-6 text-center hover-lift">
            ...
            <h3 class="text-lg font-semibold text-secondary mb-2">{{ $t('universityDetail.keyInformation.languages') }}</h3>
          ...
          <div class="bg-white rounded-2xl shadow-custom p-6 text-center hover-lift">
            ...
            <h3 class="text-lg font-semibold text-secondary mb-2">{{ $t('universityDetail.keyInformation.students') }}</h3>
            <p class="text-gray-600">{{ university.keyInfo.studentsCount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ' ') }}</p>
          </div>
          ...
          <div class="bg-white rounded-2xl shadow-custom p-6 text-center hover-lift">
            ...
            <h3 class="text-lg font-semibold text-secondary mb-2">{{ $t('universityDetail.keyInformation.accommodation') }}</h3>
          ...
          <div class="bg-white rounded-2xl shadow-custom p-6 text-center hover-lift">
            ...
            <h3 class="text-lg font-semibold text-secondary mb-2">{{ $t('universityDetail.keyInformation.ranking') }}</h3>
          ...
          <div class="bg-white rounded-2xl shadow-custom p-6 text-center hover-lift">
            ...
            <h3 class="text-lg font-semibold text-secondary mb-2">{{ $t('universityDetail.keyInformation.internationalStudents') }}</h3>
    ...
    <section class="py-16 bg-background">
      <div class="container mx-auto px-4 lg:px-6">
        <div class="max-w-4xl mx-auto">
          <h2 class="text-3xl lg:text-4xl font-bold text-secondary mb-8 text-center">{{ $t('universityDetail.aboutUniversity.title') }}</h2>
          
          <div class="space-y-8">
            <div class="bg-white rounded-2xl shadow-custom p-8">
              <h3 class="text-2xl font-semibold text-secondary mb-4">{{ $t('universityDetail.aboutUniversity.history') }}</h3>
            ...
            <div class="bg-white rounded-2xl shadow-custom p-8">
              <h3 class="text-2xl font-semibold text-secondary mb-4">{{ $t('universityDetail.aboutUniversity.campus') }}</h3>
              <p class="text-gray-600 leading-relaxed">
            ...
            <div class="bg-white rounded-2xl shadow-custom p-8">
              <h3 class="text-2xl font-semibold text-secondary mb-4">{{ $t('universityDetail.aboutUniversity.strongPrograms') }}</h3>
            ...
            <div class="bg-white rounded-2xl shadow-custom p-8">
              <h3 class="text-2xl font-semibold text-secondary mb-4">{{ $t('universityDetail.aboutUniversity.advantages') }}</h3>
              <div class="grid md:grid-cols-2 gap-6">
                <div v-for="(advantage, index) in university.about.advantages" :key="index" class="space-y-4">
...
const {
  isOpen: isModalOpen,
  userPreferences: modalPreferences,
  openModal: openApplicationModal,
  closeModal: closeApplicationModal,
  submitApplication: submitApplicationModal
} = applicationModalStore
</script>
