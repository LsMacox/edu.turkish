  ...
  <div class="flex flex-wrap justify-center gap-4 md:gap-8">
    <div class="flex items-center space-x-2 bg-white rounded-xl p-3 md:p-4 shadow-sm">
      ...
      <div>
        ...
        <p class="text-xs md:text-sm text-gray-600">{{ $t('universities_page.hero.stats.universities') }}</p>
      </div>
    </div>
    ...
    <div class="flex items-center space-x-2 bg-white rounded-xl p-3 md:p-4 shadow-sm">
      ...
      <div>
        ...
        <p class="text-xs md:text-sm text-gray-600">{{ $t('universities_page.hero.stats.cities') }}</p>
      </div>
    </div>
    ...
    <div class="flex items-center space-x-2 bg-white rounded-xl p-3 md:p-4 shadow-sm">
      ...
      <div>
        ...
        <p class="text-xs md:text-sm text-gray-600">{{ $t('universities_page.hero.stats.programs') }}</p>
      </div>
    </div>
