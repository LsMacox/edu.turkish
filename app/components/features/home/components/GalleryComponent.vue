    ...
    <div class="container mx-auto px-4 lg:px-6">
      ...
      <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
        <div class="aspect-square rounded-xl overflow-hidden hover-lift">
          <img
            ...
            src="https://storage.googleapis.com/uxpilot-auth.appspot.com/a26eb64ea3-09c0d08dd16e2f90619d.png"
        ...
        <div class="aspect-square rounded-xl overflow-hidden hover-lift">
          <img
            class="w-full h-full object-cover"
            src="https://storage.googleapis.com/uxpilot-auth.appspot.com/dbb442f9ee-ce7eba4b4960146db10a.png"
        ...
        <div class="aspect-square rounded-xl overflow-hidden hover-lift">
          <img
            class="w-full h-full object-cover"
            src="https://storage.googleapis.com/uxpilot-auth.appspot.com/0880995ea6-d6dedf4c92dd12564294.png"
        ...
        <div class="aspect-square rounded-xl overflow-hidden hover-lift">
          <img
            class="w-full h-full object-cover"
            src="https://storage.googleapis.com/uxpilot-auth.appspot.com/00422f2547-911759db3fa296dcfb47.png"
        ...
        <div class="aspect-square rounded-xl overflow-hidden hover-lift">
          <img
            class="w-full h-full object-cover"
            src="https://storage.googleapis.com/uxpilot-auth.appspot.com/cf01a50476-6e6002be5bec8a6f2b9c.png"
        ...
        <div class="aspect-square rounded-xl overflow-hidden hover-lift">
          <img
            class="w-full h-full object-cover"
            src="https://storage.googleapis.com/uxpilot-auth.appspot.com/f70c32bc00-29222ef1ecb1d31579cc.png"
        ...
        <div class="aspect-square rounded-xl overflow-hidden hover-lift">
          <img
            class="w-full h-full object-cover"
            src="https://storage.googleapis.com/uxpilot-auth.appspot.com/ac216abdac-21447a489ba7c6ff578a.png"
        ...
        <div class="aspect-square rounded-xl overflow-hidden hover-lift">
          <img
            class="w-full h-full object-cover"
            src="https://storage.googleapis.com/uxpilot-auth.appspot.com/7f108483c1-4f9c7b6afc5b5bd47e5e.png"
        ...
        <div class="aspect-square rounded-xl overflow-hidden hover-lift">
          <img
            class="w-full h-full object-cover"
            src="https://storage.googleapis.com/uxpilot-auth.appspot.com/e5acf5ab91-4366e997250e9d9caf3e.png"
        ...
        <div class="aspect-square rounded-xl overflow-hidden hover-lift">
          <img
            class="w-full h-full object-cover"
            src="https://storage.googleapis.com/uxpilot-auth.appspot.com/1f3dcd7a4e-26a7d8d42fadba16a36b.png"
        ...
        <div class="aspect-square rounded-xl overflow-hidden hover-lift">
          <img
            class="w-full h-full object-cover"
            src="https://storage.googleapis.com/uxpilot-auth.appspot.com/959a74dc15-db18a3e4aff7e6f98cfc.png"
        ...
        <div class="aspect-square rounded-xl overflow-hidden hover-lift">
          <img
            class="w-full h-full object-cover"
            src="https://storage.googleapis.com/uxpilot-auth.appspot.com/a98882a3d5-6c6ea09128dfcb3bc3ba.png"
      ...
      <div class="text-center mt-8">
        ...
        >
          ...
          <span>Подписаться на Instagram</span>
        </a>
      </div>
    </div>
  </section>
