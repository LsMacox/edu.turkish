...
type FaqBlock = Extract<BlogArticleContentBlock, { type: 'faq' }>

type HeadingBlockWithId = HeadingBlock & { id: string }
type NormalizedBlock = HeadingBlockWithId | ParagraphBlock | ListBlock | QuoteBlock | ImageBlock | SpacerBlock | DividerBlock | FaqBlock
