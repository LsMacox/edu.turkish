<template>
  <component 
    ...
    :class="[
      ...
      clickable ? 'focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2' : ''
    ]"
    @click="handleClick"
...
const headerClasses = computed(() => {
  return props.padding === 'none' ? 'px-4 py-3 border-b border-gray-200' : 'border-b border-gray-200 pb-4 mb-4'
})
...
const footerClasses = computed(() => {
  return props.padding === 'none' ? 'px-4 py-3 border-t border-gray-200' : 'border-t border-gray-200 pt-4 mt-4'
})
