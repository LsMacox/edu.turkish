...
const sizeClasses = computed(() => {
  switch (props.size) {
    case 'sm':
      return 'px-3 py-2 md:px-4 text-sm rounded-lg'
    case 'lg':
      return 'px-6 py-4 md:px-8 text-lg rounded-xl'
    case 'xl':
      return 'px-8 py-5 md:px-10 text-xl rounded-2xl min-h-touch-48'
    default: // md
      return 'px-4 py-3 md:px-6 text-base rounded-xl'
  }
})
